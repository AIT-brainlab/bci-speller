...
NO_CHARACTER: int = 2 # number of characters in each subspellers
...
PARTICIPANT_NAME:str = "Test"
PARTICIPANT_ID:str = "Test_318"
# PARTICIPANT_ID:str="test"
RECORDING_DIR:str = "hybrid/record/hybrid/8targets/"
TYPE_OF_FILE:str = ".fif"
CSV_DIR:str = "csv/"
BLOCK_BREAK:int = 60
MARKERS:dict = {"A": 1.0, "B": 2.0, "C": 3.0, "D": 4.0, "E": 5.0, "F": 6.0, "G": 7.0, "H": 8.0, "trial_start": 99.0}