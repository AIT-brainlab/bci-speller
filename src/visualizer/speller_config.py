...
FREQS: list = [4.0,8.2, 8.4, 8.6, 8.8, 9, 9.2, 9.4, 9.6]
...
BOARD_ID:int = -1 # For testing the code without the device, use -1. For real experiment/test the code with the real device, use 8.
PARTICIPANT_NAME:str = "test"
PARTICIPANT_ID:str = "testt"
